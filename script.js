...
let yelpstuff = document.querySelector(".containerThree");
...
<div class="card-title">Yelp</div>
<div class="card-body">
${randomYelp}
</div>
</div>`
console.log(yelpHTML)
yelpstuff.innerHTML = yelpHTML
yelp.textContent = randomYelp;
console.log(yelp);
function yelper() {
  timeIdentifier = setInterval(() => {
     yelpHTML = `   <div class="card">
        <div class="card-title">Yelp</div>
        <div class="card-body">
      ${randomYelp}
      </div>
